...
router
    .route("/post/:id/like") // http://localhost:3000/api/post/:id/like
    .put(auth, postCtrl.likePost); // like a post

router
    .route("/post/:id/unlike") // http://localhost:3000/api/post/:id/unlike
    .put(auth, postCtrl.unlikePost); // unlike a post

router
    .route("/posts/following") // http://localhost:3000/api/post/following
